...
import net.ehvazend.graphics.handlers.PBHandler.State.*
...
object PBHandler {
    ...
    private data class ProgressBarData(val progressBar: ProgressBar, private val primaryState: State = State.INACTIVE) {
